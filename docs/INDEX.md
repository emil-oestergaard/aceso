...
| [`prd/`](prd/v1-hitl.md) | Product Requirement Drafts — milestone-scoped framing of the user-facing problem, the experience, success criteria, and out-of-scope items. One draft per upcoming milestone; first entry is `v1-hitl.md`. | active |
